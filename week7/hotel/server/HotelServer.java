...
public class HotelServer implements Runnable, ServerProtocol {
	...
	public synchronized String doIn(String cmd) {
		return "CheckIn successful in room 101";
	}
