...
public class Card
{
    ...
    */
	...
	public static void main(String[] args) throws IOException {
		...
		Card read1 = read(reader);
		Card read2 = read(reader);
		Card read3 = read(reader);
		
		reader.close();
		
		if (read1.equals(card1) && read2.equals(card2) && read3.equals(card3)) {
			System.out.println(read1.toString());
			System.out.println(read2.toString());
			System.out.println(read3.toString());
		} else {
			System.out.println("The cards does not match");
		}
